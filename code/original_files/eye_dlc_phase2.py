...
ellipse_file_path = sys.argv[2]
#video_file_paths = ['/allen/aibs/technology/waynew/eye/phase3/29intermediate/915587736_video-1DeepCut_resnet50_universal_eye_trackingJul10shuffle1_1030000.h5']

def fit(h5file_path):
    print(h5file_path)
    # This generates a _ellipse.h5 file
    #h5file_path = video_file_path[:-3] + '.h5' #+ 'DeepCut_resnet50_universal_eye_trackingJul10shuffle1_1030000.h5'
    #ellipse_file_path = h5file_path[:-3] + '_ellipse.h5'
    #print(h5file_path)
...
#Parallel(n_jobs=-1)(delayed(fit)(video_file_path) for video_file_path in video_file_paths)
